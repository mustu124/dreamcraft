...
const { data: cats, error: catErr } = await supabase
  .from("categories")
  .upsert([
    { name: "Resin Décor",    slug: "resin-decor", sort_order: 1 },
...
const PRODUCTS = [
  ...
  // ── TRAYS ──────────────────────────────────────────────────────────────────
  {
    ...
    description: "A dainty resin trinket tray shaped like a decorative bow. Hand-poured in your choice of colour, perfect for holding rings, earrings, or small accessories on a vanity.",
  ...
  },
  {
    ...
    description: "Soft bubble-shaped resin trinket tray, handcrafted with a smooth finish. A playful and modern touch for any desk or dressing table.",
  ...
  },
  {
    ...
    description: "Elegant feather-shaped resin tray with intricate surface detail. Handpoured and finished with a water-resistant coating — a striking piece for any bedside or vanity.",
  ...
  },
  {
    ...
    description: "A beautifully detailed maple-leaf resin tray with realistic vein texture. Ideal as a jewellery catch-all or a thoughtful gift for nature lovers.",
  ...
  },
  {
    ...
    description: "A coastal-inspired starfish-shaped resin tray — handpoured with ocean-blue or white finishes. Bring a touch of the sea to your space.",
  ...
  },
  {
    ...
    description: "An ornate Victorian-style resin trinket tray with decorative border detailing. Handcrafted to add a classic, elegant touch to any dressing table.",
  ...
  },
  {
    ...
    description: "A graceful conch-shell resin tray with smooth curves and a natural, sea-inspired silhouette. Perfect for rings, earrings, or a candle holder.",
  ...
  },
  {
    ...
    description: "A charming set of turtle-shaped resin trinket trays — a large mother turtle and smaller turtles for nesting your accessories. Great as a gift set.",
    category: "resin-decor", subcategory: "trays", is_bestseller: false, sort_order: 110,
    images: ["Turtle Tray.png", "Turtle set.png"],
    variants: [{ label: "Single Tray", price: 999 }, { label: "Set of 3", price: 1599 }],
  },
  {
    sku: "DC-TRAY-MYS", name: "Mystic Shell Tray",
    description: "An abstract shell-inspired resin tray with a mystical, ocean-meets-fantasy aesthetic. Hand-poured with pearl and blue-toned pigments.",
  ...
  },
  {
    ...
    description: "A scallop-shell shaped resin tray in soft pink, white, and grey — an elegant bedside or vanity organiser for your everyday jewellery.",
  ...
  },
  {
    ...
    description: "A sophisticated resin tray with a realistic leather-look texture — sleek, modern, and perfect for a desk or nightstand.",
  ...
  },
  {
    ...
    description: "A minimalist half-moon resin tray — clean lines, smooth finish, and endlessly versatile. Style it on a shelf, vanity, or coffee table.",
  ...
  },
  {
    ...
    description: "Organic oval resin tray with a beautiful marble or block-colour finish. Each piece is individually poured, so colours and patterns vary slightly.",
  ...
  },
  {
    ...
    description: "A beautiful heart-shaped resin tray with a striking heart-grid pattern. Styled with gold jewellery, it makes the most romantic gift.",
  ...
  },
  {
    ...
    description: "A delicate trinket tray combining floral and heart motifs — handpoured in soft pastels. Perfect for gifting or as a sweet addition to your vanity.",
  ...
  // ── COASTERS ───────────────────────────────────────────────────────────────
  {
    ...
    description: "Elegant marble-pattern beaded resin coasters in white, lime, lavender, and pink — each set is a miniature work of art for your coffee table.",
  ...
  },
  {
    ...
    description: "Fluid wavy-edged resin coasters with a smooth, heat-resistant finish. Available in ocean-inspired palettes — a beautiful everyday upgrade.",
  ...
  },
  {
    ...
    description: "Intricate mandala-pattern resin coasters in green, cream, and pink. Hand-detailed with geometric precision — a centrepiece for any table.",
  ...
  },
  {
    ...
    description: "Protective and beautiful — these evil eye motif resin coasters add a spiritual, boho touch to your home. Heat-resistant and easy to clean.",
  ...
  },
  {
    ...
    description: "Modern hexagonal resin coasters with a geometric edge — minimal, stylish, and fully customisable in colour and finish.",
  ...
  },
  {
    ...
    description: "Deep ocean-inspired resin coasters with swirling blue and teal pigments — every coaster captures the motion of the sea in miniature.",
  ...
  },
  {
    ...
    description: "Rectangle resin coasters with a subtle arched top — a sleek, modern form that works with any interior style.",
  ...
  },
  {
    ...
    description: "Serene blue resin coasters — from navy to sky blue — handpoured with smooth, swirling colour blends for a calming table setting.",
  ...
  },
  {
    ...
    description: "Smooth oval arch resin coasters with a clean, contemporary silhouette. A subtle, refined choice for everyday use.",
  ...
  },
  {
    ...
    description: "A charming resin coaster for the book lover — personalised with a coffee-and-books motif. The perfect desk companion.",
  ...
  },
  {
    ...
    description: "A complete coaster set with a matching resin stand — keep your table organised and your coasters on display between uses.",
  ...
  },
  {
    ...
    description: "A curated mixed set of resin coasters in complementary colours and finishes — ideal as a housewarming or wedding gift.",
  ...
  // ── VASES ──────────────────────────────────────────────────────────────────
  {
    ...
    description: "A textured ribbed resin vase with a tactile, sculptural quality. Stunning as a standalone piece or filled with dried botanicals.",
  ...
  },
  {
    ...
    description: "A graceful spiral-form resin vase — the twisting silhouette creates beautiful shadow play in natural light. A true statement piece.",
  ...
  },
  {
    ...
    description: "A quirky donut-shaped resin vase with a wide opening for blooms or dried stems. Playful, modern, and entirely handmade.",
  ...
  },
  {
    ...
    description: "A cluster of slim test-tube resin vases on a shared base — perfect for single-stem flowers, air plants, or as a desk ornament.",
  ...
  },
  {
    ...
    description: "An artistic hand-shaped resin vase — slender fingers form the vessel, making this as much a sculpture as a functional piece.",
  ...
  },
  {
    ...
    description: "A textured pine-cone resin vase that blends nature and craft. The scaled surface catches light beautifully — a unique décor accent.",
  ...
  },
  {
    ...
    description: "A sunflower-inspired resin vase with petal-moulded details — cheerful, handmade, and perfect for a window sill or kitchen shelf.",
  ...
  },
  {
    ...
    description: "A compact ribbed resin vase with a narrow neck — ideal for a single dried stem or as part of a shelfie arrangement.",
  ...
  },
  {
    ...
    description: "A versatile resin vase available in either a swirling marble finish or a solid block colour — choose your palette to match your space.",
  ...
  // ── PLANTERS ───────────────────────────────────────────────────────────────
  {
    ...
    description: "A smooth, handpoured resin planter in your choice of colour — perfect for succulents, cacti, or trailing plants. Durable and water-resistant.",
  ...
  },
  {
    ...
    description: "A charming tree-stump resin planter with a realistic wood-grain texture. A playful nature-themed home for your favourite plant.",
  ...
  },
  {
    ...
    description: "A sculpted lady-face resin planter — the flower crown opening holds succulents, air plants, or dried blooms. Three tones: white, cream, and beige.",
    ...
    variants: [{ label: "Single", price: 999 }, { label: "Set of 3", price: 2699 }],
  },
  {
    sku: "DC-PLAN-CUP", name: "Cupped Hands Planter",
    description: "Two cupped hands cast in smooth white resin — a poetic planter for air plants, pebbles, or small succulents. A truly meaningful gift.",
  ...
  // ── FIGURINES ──────────────────────────────────────────────────────────────
  {
    ...
    description: "An elegant slim lady statue in matte resin — minimal and modern, perfect for a shelf, mantle, or console table.",
  ...
  },
  {
    ...
    description: "A romantic couple figurine in smooth resin — a timeless symbol of love, perfect as a wedding, anniversary, or Valentine's gift.",
  ...
  },
  {
    ...
    description: "A serene resin sculpture of a blindfolded lady — capturing stillness, intuition, and inner vision. A thought-provoking art piece for any room.",
  ...
  },
  {
    ...
    description: "A graceful long-haired girl resin figurine — flowing hair, gentle pose, and a serene expression. A beautiful sculptural gift for her.",
  ...
  },
  {
    ...
    description: "A minimalist abstract lady resin figurine — smooth curves and a clean silhouette that fits effortlessly into modern or Scandi-inspired interiors.",
  ...
  },
  {
    ...
    description: "A set of abstract face resin sculptures inspired by modern art — expressive, minimalist, and endlessly conversation-worthy.",
  ...
  },
  {
    ...
    description: "A three-dimensional resin teddy bear — chunky, adorable, and fully handmade. A sweet gift for a child's room or a nostalgic adult.",
  ...
  },
  {
    ...
    description: "Playful resin balloon-dog figurines inspired by Jeff Koons — bold, colourful, and a delightful pop-art accent for any shelf.",
  ...
  },
  {
    ...
    description: "A touching family figurine set in smooth resin — parents and children in a warm embrace. The ultimate heartfelt gift for a family.",
  ...
  // ── DESK ORGANISERS ────────────────────────────────────────────────────────
  {
    ...
    description: "A sleek resin ring stand — keep your rings, bracelets, and small earrings neatly displayed and easy to reach.",
  ...
  },
  {
    ...
    description: "A wall-mountable or standing resin jewellery frame with hooks for necklaces and earrings — declutter your dressing table beautifully.",
  ...
  },
  {
    ...
    description: "A multi-compartment resin jewellery organiser — trays, hooks, and slots for rings, earrings, bracelets, and more, all in one elegant piece.",
  ...
  },
  {
    ...
    description: "A handcrafted resin desk organiser with compartments for pens, cards, and stationery — elevate your workspace with something truly unique.",
  ...
  // ── JAR CANDLES ────────────────────────────────────────────────────────────
  {
    ...
    description: "Soy wax candles in embossed constellation jars — lavender/blue, terracotta apple, and pink. Burn time up to 50 hours. A gift that lights up the room.",
  ...
  },
  {
    ...
    description: "Hand-poured soy wax sphere candles in a stunning brown marble and pink marble finish, displayed on a matching oblong resin tray. A statement centrepiece.",
  ...
  },
  {
    ...
    description: "Soy wax jar candles with hand-etched mandala motifs in green, cream, and pink. Pair beautifully with the matching mandala coasters.",
  ...
  },
  {
    ...
    description: "Soy wax candle in a textured vintage-style resin jar — classic, warm, and beautifully made. The jar becomes a keepsake long after the candle is finished.",
  ...
  },
  {
    ...
    description: "A soy wax candle in a ribbed carousel-style resin jar with a lid — elegant, gift-ready, and available in multiple scents.",
  ...
  // ── TEALIGHT HOLDERS ───────────────────────────────────────────────────────
  {
    ...
    description: "Smooth pebble-shaped resin tealight holders — set of three — cast in matte white for a soft, natural ambiance. Minimalist and beautiful.",
    ...
    variants: [{ label: "Set of 1", price: 299 }, { label: "Set of 3", price: 699 }],
  },
  {
    sku: "DC-TEA-HOL", name: "Tealight Holder",
    description: "A classic resin tealight holder — clean lines, smooth finish, and a warm amber glow when lit. Available in a range of colours.",
  ...
  },
  {
    ...
    description: "Angular geometric resin tealight holder — sharp facets create a dramatic pattern of light and shadow when lit. A modern décor statement.",
    category: "soy-candles", subcategory: "tea-lights", is_bestseller: false, sort_order: 803,
    images: ["Geometric tealight holder.png"],
    variants: [{ label: "Single", price: 399 }, { label: "Set of 3", price: 699 }],
  },
  {
    sku: "DC-TEA-POT", name: "Tealight Pot & Tray Set",
    description: "A coordinated tealight pot and matching resin tray — light the pot, place it on the tray, and create an instant centrepiece.",
  ...
  // ── DIFFUSERS ──────────────────────────────────────────────────────────────
  {
    ...
    description: "Handmade carnation-shaped resin aroma diffuser cards — heart, hibiscus, butterfly, flower, and shell designs. Add a few drops of essential oil and let your space breathe.",
  ...
  },
  {
    ...
    description: "A full carnation diffuser set — a sculptural flower-shaped resin tray with a hand-sculpted carnation, paired with a 10 ml lavender essential oil bottle.",
  ...
  // ── GIFT COMBOS ────────────────────────────────────────────────────────────
  {
    ...
    description: "A thoughtfully curated Dreamcraft gift combo — combining our best-loved resin décor pieces and soy wax candles in a beautiful presentation box.",
  ...
  },
  {
    ...
    description: "A lovingly assembled Dreamcraft gift combo with handpicked resin and candle pieces — perfect for birthdays, housewarmings, or just because.",
  ...
  },
  {
    ...
    description: "A Dreamcraft combo set featuring complementary resin décor and candle pieces — makes gifting effortless and beautiful.",
  ...
  },
  {
    ...
    description: "A curated Dreamcraft gift combo — handpicked resin and candle pieces presented together for a ready-to-gift experience.",
  ...
  },
  {
    ...
    description: "Dreamcraft at its best — a carefully chosen set of handmade resin and candle pieces for someone you love.",
  ...
  },
  {
    ...
    description: "A premium Dreamcraft gift combo with a selection of our most popular resin décor and candle pieces — wrapped and ready to delight.",
  ...
  },
  {
    ...
    description: "The ultimate Dreamcraft gift set — a generous selection of handmade pieces spanning resin décor and soy candles. For the person who deserves the very best.",
  ...
  },
  {
    ...
    description: "A beautifully cohesive set: a ribbed vase, two ribbed jar candles, and a shell trinket tray — all in matching cream tones. The perfect all-in-one lifestyle gift.",
